...
\item На Rust вам понадобится \mintinline{rust}|bytemuck::cast_slice(&vertices)|
\end{itemize}
\end{frame}
...
\item При нажатии левой кнопки мыши добавьте новую вершину в массив с координатами мыши (цвета выбирайте как угодно)
\item При нажатии правой кнопки мыши удалите последнюю вершину из массива, если он не пустой
